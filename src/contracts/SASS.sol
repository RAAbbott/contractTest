...
contract SASS is ERC721Enumerable, Ownable {
    ...
    uint256 private _saleTime = 1633014000; // September 9th @ 9:00 AM MST
    ...
    function mint(uint256 _count) public payable saleIsOpen {
        ...
        require(
            _count < _maxPerTx,
            "Ahem.. Don't be greedy, you can't recruit that many agents at once!"
        );
        require(totalSupply < MAX_KOALAS, "All agents have already been recruited. Try the black market!");
        require(
